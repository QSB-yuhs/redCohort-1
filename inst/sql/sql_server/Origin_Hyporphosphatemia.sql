...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1710281,1703093,40168220,21603167,1710281)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1710281,1703093,40168220,21603167,1710281)
  and c.invalid_reason is null
UNION
select distinct cr.concept_id_1 as concept_id
FROM
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4229557,438391)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4229557,438391)
  and c.invalid_reason is null
UNION
select distinct cr.concept_id_1 as concept_id
FROM
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (136934,138388,4300058,133729)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (136934,138388,4300058,133729)
  and c.invalid_reason is null
UNION
select distinct cr.concept_id_1 as concept_id
FROM
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4034970,4239780,140362,4223448,22856,4096805,35624485,4223448,140362,36715574,4034970,4239780)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4034970,4239780,140362,4223448,22856,4096805,35624485,4223448,140362,36715574,4034970,4239780)
  and c.invalid_reason is null
UNION
select distinct cr.concept_id_1 as concept_id
FROM
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (197921,193519)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (197921,193519)
  and c.invalid_reason is null
UNION
select distinct cr.concept_id_1 as concept_id
FROM
...
WHERE (C.condition_start_date >= DATEFROMPARTS(2002, 1, 1) and C.condition_start_date <= DATEFROMPARTS(2016, 12, 31))
...
WHERE (C.drug_era_start_date >= DATEFROMPARTS(2001, 12, 30) and C.drug_era_start_date <= DATEFROMPARTS(2016, 12, 29))
