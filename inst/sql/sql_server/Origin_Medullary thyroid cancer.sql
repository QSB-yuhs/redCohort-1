...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (133424,4178976)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (133424,4178976)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4118958,4073199,4149106,4073199,2000269)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4118958,4073199,4149106,4073199,2000269)
  and c.invalid_reason is null
UNION
select distinct cr.concept_id_1 as concept_id
FROM
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (40786813,3010989,4147378)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (40786813,3010989,4147378)
  and c.invalid_reason is null
UNION
select distinct cr.concept_id_1 as concept_id
FROM
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (40796867,3003785,42529202,4244721)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (40796867,3003785,42529202,4244721)
  and c.invalid_reason is null
UNION
select distinct cr.concept_id_1 as concept_id
FROM
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (40776802,3036535,3021200,40759656,40760890,4219426)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (40776802,3036535,3021200,40759656,40760890,4219426)
  and c.invalid_reason is null
UNION
select distinct cr.concept_id_1 as concept_id
FROM
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (40238052)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (40238052)
  and c.invalid_reason is null
UNION
select distinct cr.concept_id_1 as concept_id
FROM
...
WHERE (C.condition_start_date >= DATEFROMPARTS(2001, 12, 30) and C.condition_start_date <= DATEFROMPARTS(2016, 12, 29))
...
WHERE C.condition_start_date < DATEFROMPARTS(2016, 12, 29)
-- End Condition Occurrence Criteria
...
WHERE (C.condition_era_start_date >= DATEFROMPARTS(2001, 12, 29) and C.condition_era_start_date <= DATEFROMPARTS(2003, 12, 28))
...
) A on A.person_id = P.person_id  AND A.START_DATE >= P.OP_START_DATE AND A.START_DATE <= P.OP_END_DATE AND A.START_DATE >= DATEADD(day,-730,P.START_DATE) AND A.START_DATE <= DATEADD(day,730,P.START_DATE) ) cc 
GROUP BY cc.person_id, cc.event_id
HAVING COUNT(cc.event_id) >= 1
-- End Correlated Criteria
